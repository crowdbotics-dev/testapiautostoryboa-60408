...
## Project Structure
    ...
    ├── testapiautostoryboa_60408  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_60408`
...
2. Clone this repo and `cd testapiautostoryboa_60408`
